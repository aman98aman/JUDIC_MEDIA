...
import com.exmpale.mimi.databinding.ImagePostUserItemBinding
import com.exmpale.mimi.databinding.TextPostBookmarkItemBinding
import com.exmpale.mimi.databinding.TextPostItemBinding
import com.exmpale.mimi.databinding.TextPostUserItemBinding
...
class UserAllPostAdapter(private var list: List<PostModel>, val viewModel: MainViewModel, val context: Context) :
    ...
    class TextViewHolder(val binding1: TextPostUserItemBinding, val viewModel: MainViewModel, val context: Context) :
...
//                }
    ...
    class ImageViewHolder(val binding2: ImagePostUserItemBinding, val viewModel: MainViewModel, val context: Context) :
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): RecyclerView.ViewHolder {
        ...
        return when (viewType) {
            VIEW_TYPE_TEXT -> {
                val view =
                    TextPostUserItemBinding.inflate(LayoutInflater.from(parent.context), parent, false)
                TextViewHolder(view, viewModel, context)
            }

            VIEW_TYPE_IMAGE -> {
                val view =
                    ImagePostUserItemBinding.inflate(LayoutInflater.from(parent.context), parent, false)
